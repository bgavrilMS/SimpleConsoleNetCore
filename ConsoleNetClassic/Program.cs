...
namespace ConsoleNetClassic
{
    public class Program
    {
        static async Task Main(string[] args)
        {
            ...
            // unless ran in Debug mode, in which case it complains about STA thread (separate issue, don't focus on this)
            AccountsSettingsPane retaccountPane = AccountsSettingsPaneInterop.GetForWindow(handle); 
        }
    }
    ...
    internal static class AccountsSettingsPaneInterop
    {
        ...
        public static AccountsSettingsPane GetForWindow(IntPtr hWnd)
        {
            ...
            // THIS fails with System.UnauthorizedAccessException: 'Access is denied. (0x80070005 (E_ACCESSDENIED))'
